...
package com.immotor.sample.payment.service.gateway;
 ...
 * {@link com.immotor.sample.vendor.nullPaymentGateway.web.controller.NullPaymentGatewayProcessorController}
...
//            Order order = orderService.findOrderById(Long.parseLong(orderId));
        ...
        responseDTO.successful(true).valid(true).orderId(orderId)
                .amount(new Money(request.getParameter("total_fee")))
